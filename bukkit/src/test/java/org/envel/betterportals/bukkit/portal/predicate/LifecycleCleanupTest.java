...
import org.envel.betterportals.bukkit.tasks.AsyncBlockUpdateFinisher;
...
public class LifecycleCleanupTest {
    ...
    public void testPlayerDataManagerReloadVsDisable() {
        ...
        org.envel.betterportals.bukkit.events.IEventRegistrar mockRegistrar = (org.envel.betterportals.bukkit.events.IEventRegistrar) Proxy.newProxyInstance(
                org.envel.betterportals.bukkit.events.IEventRegistrar.class.getClassLoader(),
                new Class<?>[]{org.envel.betterportals.bukkit.events.IEventRegistrar.class},
                (proxy, method, args) -> null
        );

        org.envel.betterportals.bukkit.player.IPlayerData.Factory mockFactory = (org.envel.betterportals.bukkit.player.IPlayerData.Factory) Proxy.newProxyInstance(
                org.envel.betterportals.bukkit.player.IPlayerData.Factory.class.getClassLoader(),
                new Class<?>[]{org.envel.betterportals.bukkit.player.IPlayerData.Factory.class},
                (proxy, method, args) -> {
                    String mName = method.getName();
                    if (mName.equals("create")) {
                        return Proxy.newProxyInstance(
                                org.envel.betterportals.bukkit.player.IPlayerData.class.getClassLoader(),
                                new Class<?>[]{org.envel.betterportals.bukkit.player.IPlayerData.class},
    ...
    public void testEventRegistrarReload() {
        ...
        org.envel.betterportals.bukkit.events.EventRegistrar registrar = new org.envel.betterportals.bukkit.events.EventRegistrar(mockPlugin, logger);
    ...
    public void testExternalBlockWatcherManagerClear() throws Exception {
        org.envel.betterportals.bukkit.block.external.IBlockChangeWatcher.Factory mockWatcherFactory = (org.envel.betterportals.bukkit.block.external.IBlockChangeWatcher.Factory) Proxy.newProxyInstance(
                org.envel.betterportals.bukkit.block.external.IBlockChangeWatcher.Factory.class.getClassLoader(),
                new Class<?>[]{org.envel.betterportals.bukkit.block.external.IBlockChangeWatcher.Factory.class},
                (proxy, method, args) -> {
                    if (method.getName().equals("create")) {
                        return Proxy.newProxyInstance(
                                org.envel.betterportals.bukkit.block.external.IBlockChangeWatcher.class.getClassLoader(),
                                new Class<?>[]{org.envel.betterportals.bukkit.block.external.IBlockChangeWatcher.class},
        ...
        org.envel.betterportals.bukkit.net.requests.GetBlockDataChangesRequest request = new org.envel.betterportals.bukkit.net.requests.GetBlockDataChangesRequest();
