...
public interface IPlayerData {
     ...
     * @param skipRendering when true, skip the expensive viewable-portal check (e.g. TPS too low).
     */
    void onUpdate(boolean skipRendering);

    /**
     * Convenience overload — does not skip rendering.
     */
    default void onUpdate() { onUpdate(false); }
