package org.envel.betterportals.bukkit.portal.storage;
...
import org.envel.betterportals.bukkit.portal.Portal;
...
public class YamlPortalStorage extends IPortalStorage    {
    ...
    public YamlPortalStorage(JavaPlugin pl, Logger logger, IPortalManager portalManager, MiscConfig miscConfig, LegacyPortalLoader legacyPortalLoader) {
        ...
        ConfigurationSerialization.registerClass(PortalPosition.class, "org.envel.betterportals.bukkit.portal.PortalPosition");
    }
