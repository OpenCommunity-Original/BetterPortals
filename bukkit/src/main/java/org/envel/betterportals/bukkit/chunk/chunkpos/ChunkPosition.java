package org.envel.betterportals.bukkit.chunk.chunkpos;
...
public class ChunkPosition implements Cloneable {
    ...
    public Location getCenterPos() {
        // Directly compute center: avoids the extra Location allocation from getBottomLeft() + add()
        return new Location(world, (x << 4) + 8, 128, (z << 4) + 8);
    }
