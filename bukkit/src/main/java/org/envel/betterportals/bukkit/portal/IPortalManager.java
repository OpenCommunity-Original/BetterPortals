...
public interface IPortalManager {
    ...
    /**
     * Tests the portals against the {@link org.envel.betterportals.bukkit.portal.predicate.PortalPredicateManager} to find which ones are activatable by this player.
